...
# Create a mapping from folder names to actual names
name_mapping = {
    "person1": "Meena",
    "person2": "Gun",
    "person3": "Shokun",
...
# Replace folder names with actual names
known_face_names = [name_mapping.get(name, name) for name in known_face_names]
...
video_capture.set(cv2.CAP_PROP_FPS, 5)  # Set FPS if possible
